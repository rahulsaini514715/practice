...
//-----------------------------------------------------------------------------------------------------------------------------
        char[] charac = {'a', 'c', 'f', 'h'};
        char target = 'd'; // Replace 'd' with any character you want to find the next greatest element for

        char result = nextGreatestElement(charac, target);
        System.out.println("Next greatest element after " + target + " is: " + result);
