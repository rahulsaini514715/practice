...
public class KokoEatingBananas {
    ...
    public static void main(String[] args) {
        int[] piles = {3, 6, 7, 11}; // Example pile sizes
        int h = 8; // Example number of hours

        KokoEatingBananas obj = new KokoEatingBananas(); // Creating an object
        int result = obj.minEatingSpeed(piles, h); // Calling the function
