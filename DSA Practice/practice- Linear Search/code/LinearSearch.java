...
public class LinearSearch {
    ...
    public static void linearSearch(int arr[], int target, boolean findLast) {
        ...
        if (ans == -1) {
            System.out.println("linearSearch :- Element is not present in the array");
        } else {
            System.out.println("linearSearch :- Found element at pos: " + ans);
        }
    }
    ...
    public static void linearSearchMultiple(int arr[], int target) {
        ...
        if (k == 0) {
            System.out.println("linearSearchMultiple :- Element is not present in the array");
        } else {
            for (int i = 0; i < k; i++) {
                System.out.println("linearSearchMultiple :- Found element at pos: " + ans[i]);
            }
        }
    }
