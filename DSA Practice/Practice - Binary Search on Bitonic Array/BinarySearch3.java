...
public class BinarySearch3 {
    ...
    public static void main(String[] args) {
        ...
        if (index == -1) {
            System.out.println("findPeakElementInBitonicArray : Element does not exist");
        } else {
            System.out.println("findPeakElementInBitonicArray : Found " + arr[index] + " at: " + index);
        }
    ...
    static void findElementInBitonicArray(int arr[], int target) {
        ...
        if (index == -1 || target > arr[index]) {
            ...
            if (target == arr[index]) {
                System.out.println("findElementInBitonicArray : Found " + arr[index] + " at: " + index);
                return;
            }
            // search in left half
            ...
            if (ans == -1) {
                System.out.println("findElementInBitonicArray : Element does not exist");
            } else {
                System.out.println("findElementInBitonicArray : Found " + arr[ans] + " at: " + ans);
            }
        }
    }
    ...
    static void findMinElementInBitonicArray(int arr[]) {
        if (arr.length == 0) {
            ...
            System.out.println("Minn element is: " + arr[0]);
        } else {
